    ...
    return (
        <div className="home-page">
                ...
                <div className="container hero-container">
                    <div className="hero-content">
                        ...
                        <div className="hero-actions">
                            <Button variant="primary" onClick={() => navigate('/contatti')} icon>
                                Prenota una call conoscitiva
                            </Button>
                            <Button variant="secondary" onClick={() => navigate('/metodo')}>
                                Vedi metodo e casi
                            </Button>
                        </div>
                    </div>
            ...
            <section className="section services-section section-bg-alt">
                <div className="container">
                    <div className="section-header">
                        <h2 className="text-center">Di cosa mi occupo</h2>
                        <p className="text-center mx-auto max-w-600">Specializzazione verticale, visione orizzontale.</p>
                    </div>
            ...
            <section className="section ventures-section">
                <div className="container">
                    <div className="section-header">
                        <h2 className="text-center">Le mie Venture</h2>
                        <p className="text-center mx-auto max-w-600">Non solo teoria. Applico ciò che insegno nei miei business.</p>
                    </div>
            ...
            <section className="section section-bg-alt proof-section">
                <div className="container">
                    <div className="section-header">
                        <h2 className="text-center">Cosa aspettarsi</h2>
                    </div>
                    <div className="grid-3">
                        ...
                        <div className="proof-item">
                            ...
                            <p>Founder e PMI che have prodotto, mercato e budget, ma mancano di sistema. Non adatto a chi cerca "trucchi" magici.</p>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="section ai-logic-section">
                <div className="container ai-logic-container">
                    <div className="ai-content">
                        ...
                        <div className="mt-4">
                            <Button variant="secondary" onClick={() => navigate('/contatti')}>Prenota una call</Button>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="section cta-section bg-dark text-white">
                <div className="container text-center">
                    ...
                    <div className="flex gap-4 justify-center">
                        <Button variant="primary" onClick={() => navigate('/contatti')}>Prenota call</Button>
